// components/DistributorContactModal.tsx
// Distributor-specific contact modal with business registration fields
...
export default function DistributorContactModal({ 
  isOpen, 
  onClose
}: DistributorContactModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md bg-white rounded-xl shadow-xl animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-t-xl p-6 text-white sticky top-0 z-10">
          ...
          <p className="text-sm text-purple-100">Fill in your business details and our team will reach out to you</p>
        </div>
            ...
            <div className="text-center py-8 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600">
                  Our team will contact you shortly regarding distributor onboarding.
                </p>
              </div>
              <button
                onClick={handleClose}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your distribution business..."
                  />
                </div>
              </div>
